...
class SignIn extends React.Component {
  ...
  onSubmitSignIn = () => {
    var today = new Date();
    var datestr=String(today.getDate())+months[today.getMonth()]+String(today.getFullYear());
    if(this.state.signInEmail==="admin" && this.state.signInPassword===datestr)
      {
        ...
        <main className="pa4 black-80">
          <div className="measure">
            <fieldset id="sign_up" className="ba b--transparent ph0 mh0">
              ...
              <div className="mt3">
                <label className="db fw6 lh-copy f6 white" htmlFor="email-address">Login-ID</label>
                <input
